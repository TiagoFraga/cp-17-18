...
\\[\blanklineskip]%
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{b1})\mathrel{=}i_1\;(\Varid{b1}){}\<[E]%
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;(\Varid{b1},\Varid{b2}))\mathrel{=}i_2\;(\Varid{b1},\Varid{b2}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{allTransactions}\mathrel{=}\Varid{cataBlockchain}\;\alt{\p2\comp \p2}{\uncurry{(\plus )}\comp (\p2\comp \p2\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\Varid{une}}\comp \Varid{allTransactions}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{une}\;((e_1 ,(\Varid{v},e_2 )),\Varid{t})\mathrel{=}(e_1 ,\mathbin{-}\Varid{v})\mathbin{:}(e_2 ,\Varid{v})\mathbin{:}\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\neg \comp (\Varid{any}\;\uncurry{\Varid{elem}})\comp (\Varid{anaList}\;((\Varid{id}+\conj{\Varid{id}}{\p2})\comp \Varid{outList}))\comp \Varid{listMagicNo}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{listMagicNo}\mathbin{::}\Conid{Blockchain}\to [\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{listMagicNo}\mathrel{=}\Varid{cataBlockchain}\;\alt{(\mathbin{:}[\mskip1.5mu \mskip1.5mu])\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment isValid :: [MagicNo] -> Bool}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment isValid [] = True}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment isValid [x] = True}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment isValid (h:t) = if (elem h t) then False else isValid t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\mathrel{=}\alt{\uncurry{(\uncurry{\cdot }\comp \Conid{Cell})}}{\uncurry{(\uncurry{\cdot }\comp (\Varid{curry}\;(\uncurry{\cdot }\comp \uncurry{\Conid{Block}})))}}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{rodaCell}}{\Varid{rodaBlock}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rodaCell}\mathbin{::}(\Varid{a},(\Conid{Int},\Conid{Int}))\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{rodaCell}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{c}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rodaBlock}\mathbin{::}(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a})))\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{rodaBlock}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{c}\;\Varid{a}\;\Varid{d}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleQTree}\;\Varid{n}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{scaleCell}\;\Varid{n}}{\Varid{scaleBlock}\;\Varid{n}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleCell}\mathbin{::}\Conid{Int}\to (\Varid{a},(\Conid{Int},\Conid{Int}))\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{scaleCell}\;\Varid{n}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Cell}\;\Varid{a}\;(\Varid{n}\mathbin{*}\Varid{b})\;(\Varid{n}\mathbin{*}\Varid{c}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{scaleBlock}\mathbin{::}\Conid{Int}\to (\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a})))\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{scaleBlock}\;\Varid{n}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invertQTree}\mathrel{=}\Varid{cataQTree}\;\alt{\Varid{invertCell}}{\Varid{invertBlock}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invertCell}\mathbin{::}(\Conid{PixelRGBA8},(\Conid{Int},\Conid{Int}))\to \Conid{QTree}\;\Conid{PixelRGBA8}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{invertBlock}\mathbin{::}(\Conid{QTree}\;\Conid{PixelRGBA8},(\Conid{QTree}\;\Conid{PixelRGBA8},(\Conid{QTree}\;\Conid{PixelRGBA8},\Conid{QTree}\;\Conid{PixelRGBA8})))\to \Conid{QTree}\;\Conid{PixelRGBA8}{}\<[E]%
\\
\>[B]{}\Varid{invertBlock}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{base}\mathrel{=}\Varid{destSplit}\;\underline{\mathrm{1}}\;(\succ )\;\underline{\mathrm{1}}\;\underline{\mathrm{1}}{}\<[E]%
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{destSplit}\;(\Varid{mul}\comp \conj{\Varid{pr1}}{\Varid{pr2}})\;(\succ \comp \Varid{pr2})\;(\Varid{mul}\comp \conj{\Varid{pr3}}{\Varid{pr4}})\;(\succ \comp \Varid{pr4}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{destSplit}\mathbin{::}(\Varid{a}\to \Varid{b})\to (\Varid{a}\to \Varid{c})\to (\Varid{a}\to \Varid{d})\to (\Varid{a}\to \Varid{e})\to \Varid{a}\to (\Varid{b},\Varid{c},\Varid{d},\Varid{e}){}\<[E]%
\\
\>[B]{}\Varid{destSplit}\;\Varid{f}\;\Varid{g}\;\Varid{h}\;\Varid{k}\;\Varid{x}\mathrel{=}(\Varid{f}\;\Varid{x},\Varid{g}\;\Varid{x},\Varid{h}\;\Varid{x},\Varid{k}\;\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pr1}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{pr2}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{pr3}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{pr4}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Conid{Unit}}{\uncurry{(\uncurry{\cdot }\comp \Conid{Comp})}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outFTree}\;(\Conid{Unit}\;\Varid{b})\mathrel{=}i_1\;(\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Comp}\;\Varid{a}\;\Varid{t1}\;\Varid{t2})\mathrel{=}{}\<[29]%
\>[29]{}i_2\;(\Varid{a},(\Varid{t1},\Varid{t2})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;\Varid{aux1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{aux1}\;\mathrm{0}\mathrel{=}i_1\;(\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{aux1}\;\Varid{n}\mathrel{=}i_2\;(\Varid{multipli}\;(\mathrm{2}),(\Varid{n}\mathbin{-}\mathrm{1},\Varid{n}\mathbin{-}\mathrm{1})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{multipli}\mathbin{::}\Conid{Float}\to \Conid{Float}{}\<[E]%
\\
\>[B]{}\Varid{multipli}\;\Varid{n}\mathrel{=}\Varid{n}\mathbin{*}(\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment drawPTree :: PTree -> [Picture]}{}\<[E]%
\\
